...
//       });
//       logger.error(
//         "❌ FAILED: Unexpectedly created a folder with ID: " + folder.id
//       );
//     } catch (error: any) {
//       if (error instanceof PermitError) {
//         logger.info(
//           "✅ PASSED: Correctly denied folder creation: " + error.message
//         );
//       } else {
//         logger.error(
//           "⚠️ ERROR: Non-permission error occurred: " + error.message
//         );
//       }
//     }
...
//       if (error instanceof PermitError) {
//         logger.info(
//           "✅ PASSED: Correctly denied folder update: " + error.message
//         );
//       } else {
//         logger.error(
//           "⚠️ ERROR: Non-permission error occurred: " + error.message
...
//       if (error instanceof PermitError) {
//         logger.info(
//           "✅ PASSED: Correctly denied file update: " + error.message
//         );
//       } else {
//         logger.error(
//           "⚠️ ERROR: Non-permission error occurred: " + error.message
...
//       if (error instanceof PermitError) {
//         logger.info(
//           "✅ PASSED: Correctly denied file deletion: " + error.message
//         );
//       } else {
//         logger.error(
//           "⚠️ ERROR: Non-permission error occurred: " + error.message
...
//       });
//       logger.error(
//         "❌ FAILED: Unexpectedly created a file with ID: " + file.id
//       );
//     } catch (error: any) {
//       if (error instanceof PermitError) {
//         logger.info(
//           "✅ PASSED: Correctly denied file creation: " + error.message
//         );
//       } else {
//         logger.error(
//           "⚠️ ERROR: Non-permission error occurred: " + error.message
...
//       });
//       logger.info(
//         `✅ PASSED: Successfully created folder with ID: ${folder.id}`
//       );
//     } catch (error: any) {
...
//       });
//       logger.info(
//         `✅ PASSED: Successfully updated folder name to: ${updatedFolder.name}`
//       );
//     } catch (error: any) {
...
//       });
//       logger.info(
//         `✅ PASSED: Successfully updated file content to: "${updatedFile.content}"`
//       );
//     } catch (error: any) {
